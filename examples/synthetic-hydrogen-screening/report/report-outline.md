# LCA report — Synthetic electrolytic hydrogen screening example
...
State the decision, functional unit, boundary, leading results, uncertainty/conditions, and uses that are not supported.

## 1. Commissioner, practitioner, intended application, audience, and disclosure

## 2. Product system, function, functional unit, and reference flows

## 3. System boundary, cutoffs, allocation, recycling, and modeling approach

## 4. Inventory methods, process engineering, data sources, and data quality
